...
public class UnitConverter {
	...
	public static void main(String[] args){
		...
		double km2miles= TemperatureConversion.convertkmtomiles(km);
		System.out.println("km to miles is "+km2miles);
		
		System.out.println("Enter the Distance in miles :");
		double miles=input.nextDouble();
		double miles2km= TemperatureConversion.convertmilestokm(miles);
		System.out.println("miles to km is "+miles2km);
		
		System.out.println("Enter the Distance in meters :");
		double meters=input.nextDouble();
		double meters2feet= TemperatureConversion.convertmeterstofeet(meters);
		System.out.println("meters to feet is "+meters2feet);
		
		
		System.out.println("Enter the Distance in feet :");
		double feet=input.nextDouble();
		double feet2meters= TemperatureConversion.convertfeettometers(feet);
